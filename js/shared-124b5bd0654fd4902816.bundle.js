...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return makeGrid; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return advanceGrid; });
function makeGrid(size, makeRandom) {
    if (makeRandom === void 0) { makeRandom = false; }
    var grid = [];
...
function advanceGrid(grid) {
    ...
    var calculateNeighbor = function (x, y) {
    ...
    for (var i = 0; i < gridHeight; i++) {
        ...
        for (var j = 0; j < gridWidth; j++) {
            var cellIsAlive = grid[i][j].alive;
            var neighbors = calculateNeighbor(i, j);
            if (cellIsAlive) {
                if (neighbors < 2) {
...
//# sourceMappingURL=shared-124b5bd0654fd4902816.bundle.js.map